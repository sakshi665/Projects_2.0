...
const allTicketsBtn = document.querySelector(".all-tickets");
...
allTicketsBtn.addEventListener("click", function () {
  let ticketsArray = Array.from(document.querySelector(".main-cont").children);
